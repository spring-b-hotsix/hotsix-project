...
public class ChecklistController {
    ...
    public ResponseEntity<ApiResponseDto> createChecklist(
        ...
        ChecklistResponseDto responseDto = checklistService.createChecklist(boardId, sideId, cardId, requestDto);
    ...
    public ResponseEntity<ApiResponseDto> getChecklists(
            @PathVariable Long boardId, @PathVariable Long sideId, @PathVariable Long cardId) {
        ChecklistsResponseDto responseDto = checklistService.getChecklists(boardId, sideId, cardId);
    ...
    public ResponseEntity<ApiResponseDto> updateChecklistName(
            ...
            @RequestBody ChecklistRequestDto requestDto) {
        ChecklistResponseDto responseDto = checklistService.updateChecklistName(boardId, sideId, cardId, checklistId, requestDto);
        return ResponseEntity.ok().body(responseDto);
    }
    ...
    public ResponseEntity<ApiResponseDto> deleteChecklist(
            @PathVariable Long boardId, @PathVariable Long sideId, @PathVariable Long cardId, @PathVariable Long checklistId) {
        checklistService.deleteChecklist(boardId, sideId, cardId, checklistId);
    ...
    public ResponseEntity<ApiResponseDto> createItem(
        ...
        ChecklistItemResponseDto responseDto = checklistService.createItem(boardId, sideId, cardId, checklistId, requestDto);
    ...
    public ResponseEntity<ApiResponseDto> updateItemChecked(
        ...
        ChecklistItemResponseDto responseDto = checklistService.updateItemChecked(boardId, sideId, cardId, checklistId, itemId);
        return ResponseEntity.ok().body(responseDto);
    }
    ...
    public ResponseEntity<ApiResponseDto> updateItemContent(
            @PathVariable Long boardId, @PathVariable Long sideId, @PathVariable Long cardId, @PathVariable Long checklistId,
            @PathVariable Long itemId, @RequestBody ChecklistItemRequestDto requestDto) {
        ChecklistItemResponseDto responseDto = checklistService.updateItemContent(boardId, sideId, cardId, checklistId, itemId, requestDto);
        return ResponseEntity.ok().body(responseDto);
    }
    ...
    public ResponseEntity<ApiResponseDto> deleteItem(
            @PathVariable Long boardId, @PathVariable Long sideId, @PathVariable Long cardId, @PathVariable Long checklistId,
            @PathVariable Long itemId) {
        checklistService.deleteItem(boardId, sideId, cardId, checklistId, itemId);
